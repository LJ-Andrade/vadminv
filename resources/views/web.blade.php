        ...
        <div class="container bgimg-container">
            <div class="row mobile-flex-column">
                <div class="col-md-4 col-sm-4 col-xs-12 bgimg-link wow animated fadeIn" data-wow-delay="200ms">
                    <a href="{{ url('https://vdeverde.mercadoshops.com.ar/kit-para-regalos_qO27058343XtOcxSM') }}" target="_blank">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 bgimg-link wow animated fadeIn" data-wow-delay="400ms">
                    <a href="{{ url('https://vdeverde.mercadoshops.com.ar/accesorios-jardin_qO27284169XtOcxSM') }}" target="_blank">
            ...
            <div class="row mobile-flex-column">
                <div class="col-md-6 col-sm-6 col-xs-12 bgimg-link wow animated fadeIn" data-wow-delay="500ms">
                    <a href="{{ url('https://vdeverde.mercadoshops.com.ar/huerta-en-jardin_qO27061125XtOcxSM') }}" target="_blank">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 bgimg-link wow animated fadeIn" data-wow-delay="600ms">
                    <a href="{{ url('https://vdeverde.mercadoshops.com.ar/huerta-urbana_qO27061017XtOcxSM') }}" target="_blank">
        ...
        <div class="container">
            <div class="row shop-preview">
                <div class="col-md-4 col-sm-4 col-xs-12 shop-item-preview">
                    <div class="inner">
                        <a href="{{ url('https://vdeverde.mercadoshops.com.ar/huerta-organica-individual-ideal-aromaticas-en-distintas-variedad-de-maderas-551260335xJM') }}" target="_blank">
                            <div class="image">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 shop-item-preview">
                    <div class="inner">
                        <a href="{{ url('https://vdeverde.mercadoshops.com.ar/huerta-organica-maceta-de-diseno-decoracion-ideal-esquinero-apto-aromaticas-opcion-en-diferente-variedad-de-maderas-551260347xJM') }}" target="_blank">
                            <div class="image">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 shop-item-preview wow animated fadeIn" data-wow-delay="300ms">
                    <div class="inner">
                        <a href="{{ url('https://vdeverde.mercadoshops.com.ar/huerta-organica-ideal-34-plantines-de-aromaticas-macetas-disponibles-en-diferentes-opciones-de-maderas-551260282xJM') }}" target="_blank">
                            <div class="image">
